...
initial_writer = Agent(
    ...
    model=MODEL,
    instruction="""
    Ти письменник. Запитай у користувача тему історії, потім напиши початковий варіант короткої історії (1-2 речення).
    Якщо користувач вже дав тему, використай її.
